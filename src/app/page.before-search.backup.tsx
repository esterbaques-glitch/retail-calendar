          ...
          <section className="overflow-hidden rounded-2xl border bg-white shadow-sm">
              ...
              <div className="mt-5 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <select
                    ...
                    className="rounded-xl border bg-white px-3 py-2 text-sm font-medium outline-none transition focus:border-slate-400 focus:ring-2 focus:ring-slate-200"
                  >
            ...
            <div className="p-4 sm:p-6">
              ...
              <p className="mt-4 text-xs text-slate-400">
                El filtro afecta únicamente a la vista. Las acciones siguen
                guardadas en el calendario.
              </p>
            </div>
